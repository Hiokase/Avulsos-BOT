...
const vcard = 'BEGIN:VCARD\n' 
            + 'VERSION:3.0\n' 
            + 'FN:Affis Admin\n' 
            + 'ORG: Pengembang AVBot;\n' 
            + 'TEL;type=CELL;type=VOICE;waid=5569999662600:+55 69 99966-2600\n' 
            + 'END:VCARD' 
prefix = '!'
blocked = []          
...
const { tanggal, wakt, whatsapp, nomer, ontime } = config
...
client.on('qr', qr => {
   ...
   console.log(`[ ${time} ] Escanear o código com o celular que deseja executar o Avulsos-BOT!`)
})

client.on('credentials-updated', () => {
   const authInfo = client.base64EncodedAuthInfo()
   console.log(`atualização de credenciais!`)
...
client.on('group-participants-update', async (anu) => {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			const ownerNumber = ["5569999662600@s.whatsapp.net"] 
          ...
          case 'ping':
            ...
            case 'kangcopet':
                ...
                case 'bug':
                    ...
                    client.sendMessage('5569999662600@s.whatsapp.net', options, text, {quoted: mek})
            ...
            case 'owner':
            case 'creator':
                  client.sendMessage(from, {displayname: "Hokase(Alan Cipriano)", vcard: vcard}, MessageType.contact, { quoted: mek})
